...
const Billboard: React.FC<BillboardProps> = ({ data }) => {
  return (
    <div className="p-4 sm:p-6 lg:p-8 rounded-xl flex flex-col-reverse md:grid md:grid-cols-2 overflow-hidden gap-11">
      <div className="h-full w-full flex flex-col justify-center gap-y-8">
        <h1
          className={`${gloock.className} block font-bold text-4xl sm:text-6xl sm:max-w-xl `}
        >
          {data?.label}
        </h1>
