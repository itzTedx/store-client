...
const Breadcrumb = ({ page, subPage, product }: BreadcrumbProps) => {
  return (
    <>
      ...
      >
        <ol className="flex items-center flex-wrap gap-0 gap-y-2 sm:gap-1 md:gap-1.5">
          ...
          <li className="flex items-center gap-0 sm:gap-1 md:gap-1.5">
            <Link
              ...
              className="aria-[current=page]:text-foreground-700  aria-[current=page]:font-semibold text-[12px] sm:text-sm truncate"
            >
              {page.name}
            </Link>
          </li>
            ...
            <>
              ...
              <li className="flex items-center gap-0 sm:gap-1 md:gap-1.5">
                <Link
                  ...
                  aria-current="page"
                  className="aria-[current=page]:text-foreground-700 aria-[current=page]:font-medium text-[12px] sm:text-sm"
                >
                  {product.name}
                </Link>
              </li>
